...
function SingleManage() {
  ...
  const mockEvents = [
    { _id: "1", eventname: "Music Concert", artistname: "5", eventtype: "concert", eventimage: "event1.jpg", formattedCreatedAt: "2025-02-01" },
    { _id: "2", eventname: "Art Festival", artistname: "10", eventtype: "festival", eventimage: "event2.jpg", formattedCreatedAt: "2025-01-20" },
    { _id: "3", eventname: "Pub Night", artistname: "15", eventtype: "pubbar", eventimage: "event3.jpg", formattedCreatedAt: "2025-01-15" },
    { _id: "4", eventname: "Internal Showcase", artistname: "7", eventtype: "internal", eventimage: "event4.jpg", formattedCreatedAt: "2025-01-10" },
    { _id: "1", eventname: "Music Concert", artistname: "5", eventtype: "concert", eventimage: "event1.jpg", formattedCreatedAt: "2025-02-01" },
    { _id: "2", eventname: "Art Festival", artistname: "10", eventtype: "festival", eventimage: "event2.jpg", formattedCreatedAt: "2025-01-20" },
    { _id: "3", eventname: "Pub Night", artistname: "15", eventtype: "pubbar", eventimage: "event3.jpg", formattedCreatedAt: "2025-01-15" },
    { _id: "4", eventname: "Internal Showcase", artistname: "7", eventtype: "internal", eventimage: "event4.jpg", formattedCreatedAt: "2025-01-10" },
      ...
      <div className="w-full min-h-[60px] bg-[#242424] mt-[60px] fixed top-0">
        <div className="max-w-[1250px] mx-auto h-full bg-[#242424] px-4 sm:px-6 lg:px-8">
          <div className="h-[60px] flex items-center justify-center sm:justify-start  text-white font-medium">
            ...
            <Link to='/manageuser' className="ml-[20px] transition-all duration-500 px-3 py-2 hover:bg-[#191919] rounded-lg text-[16px] sm:text-[18px] md:text-[20px]">
